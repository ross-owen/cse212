...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: not removing from the queue correctly
    ...
    // Defect(s) Found: not removing from the queue correctly. need to remove from the highest index
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: not respecting zero as unlimited turns
    ...
    // Defect(s) Found: not respecting negative values as unlimited turns
